    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        if(getArguments() != null) {
            ...
            if(isEditing) {
                ...
                Long storeId = getArguments().getLong("storeId");
                // 서버에서 reviewId에 해당하는 데이터를 가져오는 로직을 여기에 구현하세요.
...
//            moveToCommunityFragment();
    ...
    private void updateReviewOnServer(Long storeId, Long reviewId, String content, float rating, List<String> imageUris) {
        // TODO: 서버에 리뷰 업데이트 요청 보내는 로직을 구현하세요.
